...
from flow.controllers.routing_controllers import Flow_Select, FlowRouter_Inner
...
vehicles.add(
    ...
    routing_controller=(partial(Flow_Select, select_edge=['in_top3_4',
                                                 'out_left0_1', 'left3_3_0', 'top2_3_0', 'left2_2_0', 'left1_2_0',
                                                 'top0_2_0'], src='in_top3_4', dest='out_left0_1'), {}),
...
inflows = InFlows()
inflows.add('in_top3_4', 'idm', probability=0.15, depart_speed='random', name='idm')
