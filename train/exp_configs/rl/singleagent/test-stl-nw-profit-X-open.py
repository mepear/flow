...
from flow.controllers.routing_controllers import Flow_Select, OpenRouter_Inner
...
vehicles.add(
    ...
    routing_controller=(partial(Flow_Select, select_edge=['top3_4_0', 'top3_3_0', 'top3_2_0', 'top3_1_0', 'left3_0_0', 'left2_0_0', 'left1_0_0',
                                                 'top0_0_0', 'left3_3_0', 'left2_3_0', 'left1_3_0', 'top0_3_0',
                                                 'top0_2_0', 'top0_1_0']), {}),
...
inflows = InFlows()
inflows.add('top3_4_0', 'idm', probability=0.3, depart_speed='random', name='idm')
