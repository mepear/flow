...
from flow.controllers.routing_controllers import Flow_Select, FluxBase_Router, FlowRouter_Inner
...
from flow.networks import GridnxmNetworkExpand
...
vehicles.add(
    ...
    # routing_controller=(partial(Flow_Select, select_edge=['in_top2_4',
    #                                              'out_left0_1', 'left2_3_0', 'left1_3_0', 'top0_3_0',
    #                                              'top0_2_0'], src='in_top2_4', dest='out_left0_1'), {}),
    routing_controller=(partial(Flow_Select, select_edge=['in_left4_2',
                                                          'out_top1_0', 'left3_0_0', 'left2_0_0', 'top3_2_0',
                                                          'top3_1_0'], src='in_left4_2', dest='out_top1_0'), {}),
...
inflows = InFlows()
inflows.add('in_left4_2', 'idm', probability=0.08, depart_speed='random', name='idm')
...
additional_params["distribution"] = 'mode-Y1'
